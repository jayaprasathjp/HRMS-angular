...
import { EmployeeTreeComponent } from './org-chart/employee-tree/employee-tree.component';
import { ProjectTreeComponent } from './org-chart/project-tree/project-tree.component';
const routes: Routes = [
    ...
    children: [
      {
        path: '',
        pathMatch: 'full',
        redirectTo: 'employee-tree', // Redirect /org-chart to /org-chart/employee-tree
      },
      {
        path: 'employee-tree',
      ...
      { path: '**', redirectTo: 'employee-tree' }, // Redirect unknown routes to employee-tree
    ],
  },
  {
    path: 'employee-list',
